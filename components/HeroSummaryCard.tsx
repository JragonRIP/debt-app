...
export function HeroSummaryCard({
  ...
  return (
    <section className="truck-hero relative overflow-hidden rounded-3xl border border-chrome/30 p-6 sm:p-8">
      <div className="pointer-events-none absolute -right-16 -top-16 h-48 w-48 rounded-full bg-chrome/5 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-20 -left-10 h-40 w-40 rounded-full bg-sky-900/25 blur-3xl" />

      <p className="mb-2 text-xs font-semibold uppercase tracking-[0.2em] text-chrome/80">
        2012 Chevrolet 1500 · Regular Cab Short Bed
      </p>
      ...
      <TruckProgressBar percent={progressPercent} />

      <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div className="rounded-xl border border-chrome/20 bg-navy-950/60 px-4 py-3">
